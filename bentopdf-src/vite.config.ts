...
if (process.env.SIMPLE_MODE === undefined) {
  process.env.SIMPLE_MODE = 'true';
}
if (!process.env.VITE_BRAND_NAME) {
  process.env.VITE_BRAND_NAME = 'PNP BUDDY';
}
if (!process.env.VITE_BRAND_LOGO) {
  process.env.VITE_BRAND_LOGO = 'images/pnp-logo.svg';
}
if (!process.env.VITE_DEFAULT_LANGUAGE) {
